...
assert.match(section, /body:is\(\.room-mode-casual,\.room-mode-battle-armed,\.room-mode-battle,\.room-mode-recount\)[\s\S]*#gm-panel \.gm-module-chat #gm-chat-messages[\s\S]*background-color:\s*#26182e/);
assert.match(section, /radial-gradient\(ellipse at 8% 18%, rgba\(190, 42, 62, \.36\)/);
assert.match(section, /radial-gradient\(ellipse at 88% 68%, rgba\(147, 70, 183, \.42\)/);
assert.match(section, /#gm-panel \.gm-module-chat \.gm-chat-header[\s\S]*linear-gradient\(90deg, rgba\(77,27,42,\.94\), rgba\(58,28,75,\.94\)/);
